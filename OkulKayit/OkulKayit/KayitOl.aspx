            ...
            <div class="modal-body mt-md-2 mt-5">
                ...
                <form action="#" method="post" runat="server">
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="TextBox1" runat="server" placeholder="Kullanıcı Adınızı Girin..." CssClass="form-control" required=""></asp:TextBox>
<%--                        <input type="text" class="form-control" placeholder="Kullanıcı Adınız Girin...." name="Name" required="">--%>
                    </div>
                    <div class="form-group">
                        <label class="col-form-label">Mail Adresi</label>
                        <asp:TextBox ID="TextBox2" runat="server" placeholder="mail@mail.com" CssClass="form-control" required=""></asp:TextBox>
                    </div>
                    <div class="form-group">
                        <label class="col-form-label">Şehriniz</label>
                        <asp:TextBox ID="TextBox3" runat="server" placeholder="Şehir..." CssClass="form-control" required=""></asp:TextBox>
                    </div>
                    <div class="form-group">
                        <label class="col-form-label">Şifreniz </label>
                        <asp:TextBox ID="TextBox4" runat="server" placeholder="*******" CssClass="form-control" required="" TextMode="Password" ></asp:TextBox>
                    </div>
                    ...
                    <asp:Button ID="Button1" runat="server" Text="Kayıt Ol" CssClass="btn btn-info" OnClick="Button1_Click" />                </form>
            </div>
            <!-- //register -->
        </div>
    </div>
